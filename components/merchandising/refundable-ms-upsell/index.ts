...
class MicrositeRefundableUpsell extends LitElement {
      ...
      <div class="container">
        <div class="text-section">
          ...
          <div>
            <div class="content">
              <slot name="sub-title">
                Get all your money back if you change <span class="no-break">your mind</span>
              </slot>
...
if (!customElements.get('refundable-ms-upsell')) {
  customElements.define('refundable-ms-upsell', MicrositeRefundableUpsell);
}

declare global {
  interface HTMLElementTagNameMap {
    'refundable-ms-upsell': MicrositeRefundableUpsell;
  }
}
